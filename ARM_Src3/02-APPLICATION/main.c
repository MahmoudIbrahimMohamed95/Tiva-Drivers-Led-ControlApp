...
volatile  uint8 Sw1_gVariable=0;
 volatile  uint8 Sw2_gVariable=0;
...
Port_ConfigType Port_Config[4] = {{PPF3 , OUTPUT , PWM , PULL_DOWN , FOUR_mA},{PPA7 , INPUT , DIO , PULL_DOWN , FOUR_mA},{PPB0 , INPUT , DIO , PULL_DOWN , FOUR_mA},{PPA2 , OUTPUT , DIO , FLOATING , FOUR_mA}};	
/*Exti_ConfigType	Exti_Config[2]={{EXTI_PA7 ,EXTI_HIGH_LEVEl ,SW1_Processing },{EXTI_PB0 , EXTI_HIGH_LEVEl ,SW2_Processing}};	*/
